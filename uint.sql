...
CREATE CAST (money AS int1) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (int1 AS int) WITH INOUT AS IMPLICIT;
...
CREATE CAST (money AS uint1) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (uint1 AS int) WITH INOUT AS IMPLICIT;
...
CREATE CAST (money AS uint2) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (uint2 AS int) WITH INOUT AS IMPLICIT;
...
CREATE CAST (money AS uint4) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (uint4 AS int) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (money AS uint8) WITH INOUT AS ASSIGNMENT;
...
CREATE CAST (uint8 AS int) WITH INOUT AS ASSIGNMENT;
